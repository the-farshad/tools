...
(function (root, factory) {
  ...
  var FIGURES = [
    ...
    { m: 1,  d: 15, type: 'b', name: 'Aram Tigran',             role: 'Kurdish-Armenian musician',              years: '1934—2009', wiki: 'https://en.wikipedia.org/wiki/Aram_Tigran' },
    ...
    { m: 2,  d: 22, type: 'd', name: 'Hejar Mukrîyanî',         role: 'Central Kurdish poet and translator',             years: '1920—1991', wiki: 'https://en.wikipedia.org/wiki/Hejar' },
    ...
    { m: 3,  d: 15, type: 'b', name: 'Hejar Mukrîyanî',         role: 'Central Kurdish poet and translator',             years: '1920—1991', wiki: 'https://en.wikipedia.org/wiki/Hejar' },
    ...
    { m: 4,  d: 1,  type: 'b', name: 'Yılmaz Güney',            role: 'Kurdish-Turkish filmmaker',              years: '1937—1984', wiki: 'https://en.wikipedia.org/wiki/Y%C4%B1lmaz_G%C3%BCney' },
    ...
    { m: 4,  d: 18, type: 'd', name: 'Hêmin Mukrîyanî',         role: 'Central Kurdish poet',                            years: '1921—1986', wiki: 'https://en.wikipedia.org/wiki/H%C3%AAmin' },
    { m: 5,  d: 2,  type: 'b', name: 'Şêrko Bêkes',             role: 'Central Kurdish poet',                            years: '1940—2013', wiki: 'https://en.wikipedia.org/wiki/Sherko_Bekas' },
    { m: 5,  d: 3,  type: 'b', name: 'Leyla Zana',              role: 'Turkish-Kurdish politician',             years: 'b. 1961',   wiki: 'https://en.wikipedia.org/wiki/Leyla_Zana' },
    ...
    { m: 5,  d: 15, type: 'b', name: 'Salim Barakat',           role: 'Syrian-Kurdish poet and novelist',       years: 'b. 1951',   wiki: 'https://en.wikipedia.org/wiki/Salim_Barakat' },
    { m: 6,  d: 11, type: 'd', name: 'Piremerd',                role: 'Central Kurdish poet, journalist',                years: '1867—1950', wiki: 'https://en.wikipedia.org/wiki/Piremerd' },
    ...
    { m: 8,  d: 4,  type: 'd', name: 'Şêrko Bêkes',             role: 'Central Kurdish poet',                            years: '1940—2013', wiki: 'https://en.wikipedia.org/wiki/Sherko_Bekas' },
    { m: 8,  d: 8,  type: 'd', name: 'Aram Tigran',             role: 'Kurdish-Armenian musician',              years: '1934—2009', wiki: 'https://en.wikipedia.org/wiki/Aram_Tigran' },
    ...
    { m: 9,  d: 9,  type: 'd', name: 'Yılmaz Güney',            role: 'Kurdish-Turkish filmmaker',              years: '1937—1984', wiki: 'https://en.wikipedia.org/wiki/Y%C4%B1lmaz_G%C3%BCney' },
    ...
    { m: 10, d: 22, type: 'd', name: 'Cegerxwîn',               role: 'Northern Kurdish poet',                          years: '1903—1984', wiki: 'https://en.wikipedia.org/wiki/Cegerxw%C3%AEn' },
    { m: 11, d: 9,  type: 'b', name: 'Piremerd',                role: 'Central Kurdish poet, journalist',                years: '1867—1950', wiki: 'https://en.wikipedia.org/wiki/Piremerd' },
    { m: 11, d: 9,  type: 'b', name: 'Abdulla Pashew',          role: 'Central Kurdish poet',                            years: 'b. 1946',   wiki: 'https://en.wikipedia.org/wiki/Abdulla_Pashew' },
    ...
    { m: 11, d: 18, type: 'd', name: 'Goran',                   role: 'Central Kurdish modernist poet',                  years: '1904—1962', wiki: 'https://en.wikipedia.org/wiki/Abdulla_Goran' },
    ...
    { m: 6,  d: 4,  type: 'd', name: 'Hesen Zîrek',             role: 'Central Kurdish singer',                          years: '1921—1972', wiki: 'https://en.wikipedia.org/wiki/Hassan_Zirak' },
    ...
    { m: 4,  d: 28, type: 'b', name: 'Bextiyar Elî',            role: 'Central Kurdish novelist',                         years: 'b. 1966',   wiki: 'https://en.wikipedia.org/wiki/Bachtyar_Ali' }
  ];
