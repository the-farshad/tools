(function () {
  ...
  const SUN_CITIES_KURD = [
    ...
    { id:'bedlis',   name:'Bitlis (Bedlîs)',   name_ar:'بدلیس',    lat:38.40, lon:42.10, tz:'Europe/Istanbul' },
    { id:'colemerg', name:'Hakkari (Colemêrg)',name_ar:'جۆلەمێرگ',  lat:37.57, lon:43.74, tz:'Europe/Istanbul' },
    { id:'duhok',    name:'Dihok',             name_ar:'دھۆک',      lat:36.86, lon:42.99, tz:'Asia/Baghdad'    },
    { id:'halabja',  name:'Halabja',           name_ar:'ھەڵەبجە',   lat:35.18, lon:45.99, tz:'Asia/Baghdad'    },
    { id:'hewler',   name:'Hewlêr (Erbil)',    name_ar:'ھەولێر',    lat:36.19, lon:43.99, tz:'Asia/Baghdad'    },
    ...
    { id:'kirkuk',   name:'Kirkuk',            name_ar:'کەرکووک',    lat:35.47, lon:44.39, tz:'Asia/Baghdad'    },
    { id:'kobane',   name:'Kobanî',            name_ar:'کۆبانی',    lat:36.89, lon:38.36, tz:'Asia/Damascus'   },
    { id:'mahabad',  name:'Mahabad',           name_ar:'مەھاباد',   lat:36.76, lon:45.72, tz:'Asia/Tehran'     },
  ...
  const SUN_CITIES_WORLD = [
    ...
    { id:'istanbul',  name:'Istanbul',      name_ar:'ئەستەمبوڵ',  lat:41.01,  lon:28.98,   tz:'Europe/Istanbul' },
    ...
    { id:'tehran',    name:'Tehran',        name_ar:'تاران',     lat:35.69,  lon:51.39,   tz:'Asia/Tehran' },
  ...
  let POEM_INDEX = [
    ...
    'ھەژار موکریانی/بۆ کوردستان/١٧. نامرادێک',
    'ھەژار موکریانی/بۆ کوردستان/٢٧. هەر کوردم',
    'ھەژار موکریانی/بۆ کوردستان/٢٠. وەرام بۆ کچێکی سۆڤیەتی',
    'ھەژار موکریانی/بۆ کوردستان/٣٣. کوردم',
